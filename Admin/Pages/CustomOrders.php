...
WHERE Delivery_Status='Pending' AND Payment_Status = 'completed' AND Cancel_Status!='cancelled';";
...
<head>
  ...
  <title>Craving Crumbs | Custom Orders</title>
        ...
        <div class="order-card">
          ...
          <div class="info">
            ...
            <div class="bottom">
              ...
              <?php echo "<td><a class='btn delivered-btn' href='../PHP/Delivered.php?CustOrderID=" . $row['Custom_Cake_ID'] . "' onClick=\"javascript:return confirm('are you sure it\\'s delivered?');\">Delivered</a></td><tr>";
              ?>
            ...
            <div class="info">
              ...
              <div class="content">
                ...
                <ul class="order-details">
                  ...
                  <li><span>Expection on :</span> <?php echo ($row['Arriving']) ?></li>
                </ul>
