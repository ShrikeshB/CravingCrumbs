...
if (isset($_GET['search'])) {
  ...
  $SearchQuery = "SELECT * FROM cakes WHERE Cake_Name LIKE '%{$searchKey}%' OR Tags LIKE '%{$searchKey}%'";
...
<head>
  ...
  <title>Craving Crumb | search</title>
...
<body>
  ...
  <section class="best-seller-section">
    <h1 class="heading" style="font-size: 18px; margin-top:2em;">Search Results for "<?php echo ($searchKey); ?>" </h1>
      ...
      ?>
        ...
        <div class="card">
          <a href="http://localhost/CakeSite/src/Pages/Details.php?cakeID=<?php echo ($row['Cake_ID']); ?>" class="container">
            <!-- Holds image of card -->
            <div class="img-container">
              <img src="../../Images/Cakes/<?php echo ($row['Category']) . "/" . ($row['Cake_Img'])   ?>" alt="cake image" />
            </div>
